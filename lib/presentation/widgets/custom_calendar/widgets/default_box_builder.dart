...
class DefaultBoxBuilder extends StatefulWidget {
  const DefaultBoxBuilder({
    required this.day,
  ...
  @override
  State<DefaultBoxBuilder> createState() => _DefaultBoxBuilderState();
}

class _DefaultBoxBuilderState extends State<DefaultBoxBuilder> {
